...
class FilterString extends Component{
    constructor(){
        ...
        this.state = {
            unfilteredArray: 
            ['I am fast', 'I am quick', 'You are smart', 'You are cool', 'You are attractice', 'He is over there', 'I know that', 'I love Programming', 'Team Jin is Number One'],
            userInput: '',
            filteredArray: []
        }
    }
    ...
    render(){
        ...
        return(
            <div className='puzzleBox filterStringPB'>
                ...
                <input className='inputLine' onChange={e => this.setInput(e.target.value)} />
